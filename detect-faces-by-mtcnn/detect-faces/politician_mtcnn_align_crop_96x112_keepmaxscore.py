...
if __name__ == "__main__":
    ...
    split_id = 10
    nsplits = 0
    # save_dir = '/disk2/zhaoyafei/politician-data/politician-v4-aligned-keepmaxscore'
    save_dir = '/disk2/zhaoyafei/politician-data/politician-v4-aligned-keepmaxscore-pinyin'
    # save_dir = './politician-v4-aligned-keepmaxscore'
