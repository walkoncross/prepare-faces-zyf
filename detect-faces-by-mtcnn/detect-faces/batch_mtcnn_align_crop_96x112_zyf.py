...
os.environ['GLOG_minloglevel'] = 2  # suppress caffe's logging
...
if __name__ == "__main__":
    ...
    list_fn = '/disk2/data/FACE/face-idcard-zxt/img-list-all-shortname.txt'
    img_root_dir = '/disk2/data/FACE/face-idcard-zxt/FaceTestData'
    split_id = 10
    nsplits = 0
    save_dir = '/workspace/idcard_bjxj_mtcnn_aligned'
